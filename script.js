...
/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   ...
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
const FAMILY_DATA = [
  { id: 'rouf', name: 'Rouf', nameBn: 'রওফ', gender: 'male', spouseIds: ['anjuman'], parentIds: [], childrenIds: ['mostak', 'feroza', 'sharmin', 'jannat'], generation: 0, ageRank: 1, avatar: { img: 'images/rouf.png', initials: 'র', color: '#a855f7' } },
  { id: 'anjuman', name: 'Anjuman', nameBn: 'আঞ্জুমান', gender: 'female', spouseIds: ['rouf'], parentIds: [], childrenIds: ['mostak', 'feroza', 'sharmin', 'jannat'], generation: 0, ageRank: 2, avatar: { img: 'images/anjuman.png', initials: 'আ', color: '#c084fc' } },
  { id: 'mostak', name: 'Mostak', nameBn: 'মোস্তাক', gender: 'male', spouseIds: ['shetu'], parentIds: ['rouf', 'anjuman'], childrenIds: [], generation: 1, ageRank: 3, avatar: { img: 'images/mostak.png', initials: 'ম', color: '#06b6d4' } },
  { id: 'shetu', name: 'Shetu', nameBn: 'শেতু', gender: 'female', spouseIds: ['mostak'], parentIds: [], childrenIds: [], generation: 1, ageRank: 4, avatar: { img: 'images/shetu.png', initials: 'শে', color: '#38bdf8' } },
  { id: 'feroza', name: 'Feroza', nameBn: 'ফেরোজা', gender: 'female', spouseIds: ['anis'], parentIds: ['rouf', 'anjuman'], childrenIds: ['sumaiya', 'tasfia', 'suaiba', 'mohammad'], generation: 1, ageRank: 5, avatar: { img: 'images/feroza.png', initials: 'ফে', color: '#f59e0b' } },
  { id: 'anis', name: 'Anis', nameBn: 'আনিস', gender: 'male', spouseIds: ['feroza'], parentIds: [], childrenIds: ['sumaiya', 'tasfia', 'suaiba', 'mohammad'], generation: 1, ageRank: 6, avatar: { img: 'images/anis.png', initials: 'আন', color: '#fbbf24' } },
  { id: 'sumaiya', name: 'Sumaiya', nameBn: 'সুমাইয়া', gender: 'female', spouseIds: [], parentIds: ['anis', 'feroza'], childrenIds: [], generation: 2, ageRank: 11, avatar: { img: 'images/sumaiya.png', initials: 'সু', color: '#fcd34d' } },
  { id: 'tasfia', name: 'Tasfia', nameBn: 'তাসফিয়া', gender: 'female', spouseIds: [], parentIds: ['anis', 'feroza'], childrenIds: [], generation: 2, ageRank: 12, avatar: { img: 'images/tasfia.png', initials: 'তা', color: '#f97316' } },
  { id: 'suaiba', name: 'Suaiba', nameBn: 'সুআইবা', gender: 'female', spouseIds: [], parentIds: ['anis', 'feroza'], childrenIds: [], generation: 2, ageRank: 13, avatar: { img: 'images/suaiba.png', initials: 'সুআ', color: '#fb923c' } },
  { id: 'mohammad', name: 'Mohammad', nameBn: 'মোহাম্মদ', gender: 'male', spouseIds: [], parentIds: ['anis', 'feroza'], childrenIds: [], generation: 2, ageRank: 14, avatar: { img: 'images/mohammad.png', initials: 'মো', color: '#ea580c' } },
  { id: 'sharmin', name: 'Sharmin', nameBn: 'শারমিন', gender: 'female', spouseIds: ['aziz'], parentIds: ['rouf', 'anjuman'], childrenIds: ['abdullah'], generation: 1, ageRank: 7, avatar: { img: 'images/sharmin.png', initials: 'শা', color: '#10b981' } },
  { id: 'aziz', name: 'Aziz', nameBn: 'আজিজ', gender: 'male', spouseIds: ['sharmin'], parentIds: [], childrenIds: ['abdullah'], generation: 1, ageRank: 8, avatar: { img: 'images/aziz.png', initials: 'আজ', color: '#34d399' } },
  { id: 'abdullah', name: 'Abdullah', nameBn: 'আব্দুল্লাহ', gender: 'male', spouseIds: [], parentIds: ['aziz', 'sharmin'], childrenIds: [], generation: 2, ageRank: 15, avatar: { img: 'images/abdullah.png', initials: 'আব', color: '#6ee7b7' } },
  { id: 'jannat', name: 'Jannat', nameBn: 'জান্নাত', gender: 'female', spouseIds: ['iftekhar'], parentIds: ['rouf', 'anjuman'], childrenIds: [], generation: 1, ageRank: 9, avatar: { img: 'images/jannat.png', initials: 'জা', color: '#ec4899' } },
  { id: 'iftekhar', name: 'Iftekhar', nameBn: 'ইফতেখার', gender: 'male', spouseIds: ['jannat'], parentIds: [], childrenIds: [], generation: 1, ageRank: 10, avatar: { img: 'images/iftekhar.png', initials: 'ই', color: '#f472b6' } },
];
const memberMap = {};
